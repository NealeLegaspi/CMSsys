...
<head>
  <meta charset="utf-8">
  <title>Form 138 - {{ $student->user->name }}</title>
  <style>
...
<body>
  <div class="header">
    ...
    <p><strong>Form 138 — Report Card</strong></p>
  </div>
  ...
  <div class="footer">
    <p>__________________________<br>Class Adviser</p>
    <p>__________________________<br>Principal</p>
  </div>
</body>
</html>
