    ...
    <div class="tab-pane fade show active" id="profile" role="tabpanel">
      <div class="card p-4">
        ...
        <div class="text-center mb-3">
          ...
          <h6 class="mt-2">Juan Dela Cruz</h6>
        </div>

        <table class="table table-striped table-bordered">
          <tr><th>Full Name</th><td>Juan Santos Dela Cruz</td></tr>
          <tr><th>Email</th><td>juan.cruz@example.com</td></tr>
          <tr><th>Contact Number</th><td>09123456789</td></tr>
          <tr><th>Gender</th><td>Male</td></tr>
          <tr><th>Birthdate</th><td>1990-01-01</td></tr>
          <tr><th>Address</th><td>Quezon City</td></tr>
        </table>

        <!-- Logout -->
        <div class="text-end">
          <a href="#" class="btn btn-danger"><i class='bx bx-log-out me-1'></i> Logout</a>
        </div>
      </div>
    </div>
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <div class="mb-3">
                ...
                <input type="email" class="form-control" value="juan.cruz@example.com">
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <textarea class="form-control" rows="2">Quezon City</textarea>
              </div>
            </div>
          </div>
        </div>
